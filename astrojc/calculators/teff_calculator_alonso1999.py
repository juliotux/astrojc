...
_equations = {1: [0.6388, 0.4065, -0.1117, -2.308e-3, -7.782e-2, -1.2e-2,
                  0.023],
              2: [0.8323, 9.374e-2, 1.184e-2, 2.351e-2, -0.1392, -1.944e-2,
                  0.020],
              3: [0.5716, 0.5404, -6.126e-2, -4.862e-2, -0.1777e-2, -7.969e-3,
                  0.020],
...
def calc_teff(equation, color, Feh, color_error=0):
    """Calculate the effective temperature using Alonso 1999 equations."""
