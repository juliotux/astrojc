...
def find(image,
    ...
    log.debug(' No. of sources rejected by SHARPNESS criteria: %s' % badsharp)
    log.debug(' No. of sources rejected by ROUNDNESS criteria: %s' % badround)
    log.debug(' No. of sources rejected by CENTROID  criteria: %s' % badcntrd)
